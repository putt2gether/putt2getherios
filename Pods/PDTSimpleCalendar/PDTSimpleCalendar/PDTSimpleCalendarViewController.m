...
- (UICollectionViewCell *)collectionView:(UICollectionView *)collectionView cellForItemAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    if (cellDateComponents.month == firstOfMonthsComponents.month) {
        ...
        [self.datesToCompare enumerateObjectsUsingBlock:^(id  _Nonnull obj, NSUInteger idx, BOOL * _Nonnull stop) {
            NSDate *dateDelegate = obj;
            NSDateComponents *components = [[NSCalendar currentCalendar] components:NSCalendarUnitDay | NSCalendarUnitMonth | NSCalendarUnitYear fromDate:dateDelegate];
            NSInteger month = [components month];
            NSInteger year = [components year];
            NSInteger day = [components day];
            
            ////Cell Date
            NSDateComponents *componentsCell = [[NSCalendar currentCalendar] components:NSCalendarUnitDay | NSCalendarUnitMonth | NSCalendarUnitYear fromDate:cellDate];
            NSInteger monthCell = [componentsCell month];
            NSInteger yearCell = [componentsCell year];
            NSInteger dayCell = [componentsCell day];
            cell.isToday = YES;
            if (month == monthCell && year == yearCell && day == dayCell)
            {
