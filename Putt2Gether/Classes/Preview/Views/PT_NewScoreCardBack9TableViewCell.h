//
//  PT_NewScoreCardBack9TableViewCell.h
//  Putt2Gether
//
...
@interface PT_NewScoreCardBack9TableViewCell : UITableViewCell
...
@property (weak, nonatomic) IBOutlet UILabel *ct22;
@property (weak, nonatomic) IBOutlet UILabel *ct21;
